...
For more details on how the Elastic, Caldera, and Guacamole services are enabled and configured, see [description](./description.md) file. The Bastion Host service is implicitly enabled if any of the previously mentioned services is enabled.
