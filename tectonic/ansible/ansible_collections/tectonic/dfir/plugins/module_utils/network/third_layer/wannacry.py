...
from ansible_collections.tectonic.dfir.plugins.module_utils.network.second_layer.tcp_plain_text_communication import tcp_plain_text_communication
from ansible_collections.tectonic.dfir.plugins.module_utils.network.second_layer.http import http_web_navigation
from ansible_collections.tectonic.dfir.plugins.module_utils.network.first_layer.tcp_primitives import Layer1Generator
from ansible_collections.tectonic.dfir.plugins.module_utils.network.utils import get_random_time, get_public_ip, now_ts
