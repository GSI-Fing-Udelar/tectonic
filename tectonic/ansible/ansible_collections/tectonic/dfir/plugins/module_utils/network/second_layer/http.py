...
from ansible_collections.tectonic.dfir.plugins.module_utils.network.second_layer.dns import dns_communication
from ansible_collections.tectonic.dfir.plugins.module_utils.network.second_layer.not_ended_tcp_connection import not_ended_tcp_connection
from ansible_collections.tectonic.dfir.plugins.module_utils.network.utils import *
