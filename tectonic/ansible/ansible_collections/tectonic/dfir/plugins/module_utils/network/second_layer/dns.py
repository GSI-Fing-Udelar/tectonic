...
from ansible_collections.tectonic.dfir.plugins.module_utils.network.first_layer.dns import create_dns_query, create_dns_response
from typing import List, Optional, Tuple
import time
import random
import subprocess
import sys
from ansible_collections.tectonic.dfir.plugins.module_utils.network.utils import seed_random, get_public_ip
