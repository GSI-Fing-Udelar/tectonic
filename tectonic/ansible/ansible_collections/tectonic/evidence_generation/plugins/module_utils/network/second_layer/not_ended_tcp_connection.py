...
from ansible_collections.tectonic.evidence_generation.plugins.module_utils.network.first_layer.tcp_primitives import Layer1Generator, rnd_port, rnd_seq, now_ts
